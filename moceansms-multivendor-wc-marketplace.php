...
/*
Plugin Name: MoceanApi WC Marketplace Extension
Description: WC Marketplace Extension for WooCommerce
Version:     1.0.0
...
// THIS IS EXTENSION FOR PLUGIN WC Marketplace (https://wordpress.org/plugins/dc-woocommerce-multi-vendor/)

if ( ! defined( 'WPINC' ) || ! ABSPATH ) {
	die;
}

add_action( 'admin_init', 'moceanapi_multivendor_wc_marketplace_extension_check_required_plugin' );
function moceanapi_multivendor_wc_marketplace_extension_check_required_plugin() {
	//check if another vendor extension installed
	$currentPluginDirectoryName = 'moceanapi-multivendor-wc-marketplace-extension';
			...
			function moceansms_multivendor_extension_error_notice() {
                ...
                <div class="error">
                    <p>Sorry, MoceanSMS Multivendor Extension requires the following plugin to be installed and
                        ...
                        - <a href="https://wordpress.org/plugins/dc-woocommerce-multi-vendor/">
                            WC Marketplace
                        </a>
                    </p>
                </div>
...
if ( is_plugin_active( 'moceansms-order-sms-notification-for-woocommerce/moceansms-woocommerce.php' ) && is_plugin_active( 'dc-woocommerce-multi-vendor/dc_product_vendor.php' ) ) {
	...
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-moceansms-multivendor-wc-marketplace-manager.php';
	require_once plugin_dir_path( __FILE__ ) . 'admin/class-moceansms-multivendor-setting.php';

	$multivendor_manager      = new Moceansms_Multivendor_WC_Marketplace_Manager();
	$multivendor_notification = new Moceansms_Multivendor_Notification( $multivendor_manager, 'Wordpress-Woocommerce-Multivendor-WC-marketplace-extension' );
